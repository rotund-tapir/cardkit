...
fun DealerButton(
    ...
    Surface(
        ...
        modifier = modifier.size(size).testTag(DealerButtonTag),
    ) {
...
/** Lets a test find the dealer marker without knowing which seat currently holds it. */
const val DealerButtonTag = "dealerButton"
